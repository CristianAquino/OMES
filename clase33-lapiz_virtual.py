...
while True:
    ...
    cv2.putText(frame, 'Limpiar', (320, 20), 6, 0.6,
                colorLimpPantalla, 1, cv2.LINE_AA)
        ...
        if area > 1000:
            ...
            if x1 is not None:
                ...
                if 300 < x2 < 400 and 0 < y2 < 50:
                    cv2.rectangle(frame, (300, 0), (400, 50),
                                  colorLimpPantalla, 1)
                    cv2.putText(frame, 'Limpiar', (320, 20), 6, 0.6,
                                colorLimpPantalla, 2, cv2.LINE_AA)
                    cv2.putText(frame, 'Pantalla', (320, 40), 6,
                                0.6, colorLimpPantalla, 2, cv2.LINE_AA)
                    imAux = np.zeros(frame.shape, dtype=np.uint8)
