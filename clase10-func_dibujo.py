...
# circulo
# valor de -1 llena el circulo
cv2.circle(imagen, (300, 200), 100, (0, 255, 0), 3)
# texto
font = cv2.FONT_HERSHEY_SIMPLEX
cv2.putText(imagen, 'GAA', (10, 30), font, 1, (255, 0, 255),
            1, cv2.LINE_AA)  # el 3 argumento es la ubicacion
